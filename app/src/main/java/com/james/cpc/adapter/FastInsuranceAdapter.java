...
public class FastInsuranceAdapter extends BaseAdapter implements Filterable {
    private ArrayList<FastListItem> mListItems;
    private LayoutInflater inflater;
    Context context;
    String TAG = FastInsuranceAdapter.class.getSimpleName();
    public FastInsuranceAdapter(Context context) {
        this.context = context;
    }

    public FastInsuranceAdapter(Context context, ArrayList<FastListItem> itemList) {
        this.context = context;
        mListItems = itemList;
    ...
    public View getView(int position, final View convertView, ViewGroup parent) {
        ...
        final FastListItem item = mListItems.get(position);
